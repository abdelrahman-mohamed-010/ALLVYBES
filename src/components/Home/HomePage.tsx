...
import { QrCode, Zap, UserPlus, LogIn, Star, Calendar, MapPin, Users, ArrowRight } from 'lucide-react';
...
export const HomePage: React.FC<HomePageProps> = ({ onNavigate }) => {
  ...
  const featuredEvents = events.filter(e => e.isLive || e.date > new Date()).slice(0, 3);
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-dark-bg' : 'bg-white'} pb-20`}>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative px-6 py-12 text-center">
          <div className="mb-8">
            ...
            <p className={`text-lg ${darkMode ? 'text-dark-text' : 'text-gray-600'}`}>
          ...
          {featuredArtists.map((artist) => (
            ...
            >
              <div className="text-center">
                ...
                <h4 className={`font-semibold mb-1 ${darkMode ? 'text-dark-text' : 'text-gray-900'}`}>
                  {artist.artistName}
                </h4>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    <h4 className={`font-bold ${darkMode ? 'text-dark-text' : 'text-gray-900'}`}>
                      {event.name}
                    </h4>
      ...
      {/* Features Grid */}
      <div className="px-6">
        <h3 className={`text-xl font-bold mb-6 ${darkMode ? 'text-dark-text' : 'text-gray-900'}`}>
          What You Can Do
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            >
              ...
              <h4 className={`font-semibold mb-2 ${darkMode ? 'text-dark-text' : 'text-gray-900'}`}>
                {feature.title}
              </h4>
              <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                {feature.description}
